...
/// {@category Endpoint}
class EndpointSystem extends _i2.EndpointRef {
  EndpointSystem(_i2.EndpointCaller caller) : super(caller);

  @override
  String get name => 'system';

  _i3.Future<String> health() => caller.callServerEndpoint<String>(
    'system',
    'health',
    {},
  );
...
/// {@category Endpoint}
class EndpointTranslation extends _i2.EndpointRef {
  EndpointTranslation(_i2.EndpointCaller caller) : super(caller);
